...
public class SmsUtil {
     ...
     * 发送短信
     * @param mobile 手机号
     * @param signName 申请的签名
     * @param templateCode 申请的模板号
     * @param templateParam 模板中对应的占位符，即参数
     * @return  发送短信的响应信息
     * @throws ClientException
     */
    public SendSmsResponse sendSms(String mobile,String signName,String templateCode,
