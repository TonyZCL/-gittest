...
public class FastDFSTest {
    ...
    public void test()throws Exception{
        ...
        String conf_filename =
                ClassLoader.getSystemResource("fastdfs/tracker.conf").getPath();
         ...
         */
        String[] upload_file =
                storageClient.upload_file("D:\\pics\\lang\\zhaopian.jpg",
                        "jpg",null);
        ...
        if (upload_file != null && upload_file.length > 1){
            ...
            for (ServerInfo serverInfo : serverInfos){
                System.out.println("ip=" + serverInfo.getIpAddr() + ";port=" +
                        serverInfo.getPort());
            }

            //组合可以访问的路径
            String url = "http://" + serverInfos[0].getIpAddr()+"/"+groupName
                    +"/"+filename;
